...
export default class ContactForm extends Component {
  ...
  onSubmitFailure = () => {
    ...
    this.setState({
      messagebox:
        "Please fill out the all fields and then try submitting again!"
    });
  ...
  onSubmitSuccess = event => {
    ...
    axios
      .post("https://naleesportfolio.herokuapp.com/main", contactInfo)
      .then(res => {
        console.log(res);
        this.setState({
          name: "",
      ...
      .catch(err => {
        this.setState({
          messagebox:
            "Sorry! There was a problem on the server, message not sent. Try emailing me!"
        });
      });
  };
  render() {
